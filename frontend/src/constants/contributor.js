export const profilTypes = {
	'developer': {
		...
		skills: [
			...
			// JavaScript
			{ value: "javascript", name: "JavaScript", color: "#F5DD1B" },
			{ value: "typescript", name: "TypeScript", color: "#3178C6" },
			{ value: "react", name: "React", color: "#61DEFB" },
			{ value: "nextjs", name: "Next.js", color: "#0070F3" },
			{ value: "react-native", name: "React Native", color: "#61DEFB" },
			...
			{ value: "ruby-on-rails", name: "Ruby On Rails", color: "#CC0000" },
			// C and others
